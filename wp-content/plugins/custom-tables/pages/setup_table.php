...
switch($_GET['wcttab2']) {
	...
	default:
		...
		echo "<div class=\"field\"><label><strong>". __('Table Name', 'wct') .":</strong>&nbsp;<input size=\"32\" type=\"text\" name=\"vipName\" value=\"".$tablename->name."\"></label></div>".
		     "<br/><strong>".__('Fields', 'wct').":</strong><br/>".
		     "<input type=\"text\" name=\"id\" value=\"id\" style=\"width:52%;float:left;\" readonly><input style=\"width:40%;\" type=\"text\" name=\"idtype\" value=\"int(11) UNIQUE\" readonly><br/>".
		     "<input type=\"text\" name=\"status\" style=\"width:52%;float:left;\" value=\"status\" readonly><input style=\"width:40%;\" type=\"text\" name=\"idtype\" value=\"enum('active','draft','passive')\" readonly><br/>".$feldoutput.
